...
import { X, FileText, Waves } from 'lucide-react';
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-700 text-sm">
                  Esta proposta será registrada de forma imutável na rede Stellar, 
                  garantindo transparência e auditabilidade completas.
                </p>
              </div>
            </div>
          </div>
